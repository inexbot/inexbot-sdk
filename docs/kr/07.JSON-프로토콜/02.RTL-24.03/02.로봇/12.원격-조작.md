...
| mouseSen  | double[4]  | [0,300]   | 3D마우스灵敏도열表，각각X방향灵敏도、Y방향灵敏도、Z방향灵敏도、자세灵敏도 |
...
| mouseSen | double[4] | [0,300]  | 3D마우스灵敏도열表，각각X/Y/Z방향灵敏도와/과자세灵敏도  |
...
| 매개변수名      | 유형 | 범위     | 설명                                   |
|-------------|------|----------|----------------------------------------|
| zeroTagged  | int  | [0,1]    | 3D마우스영점마크상태：0의미未마크，1의미완료마크 |
...
| 매개변수名   | 유형 | 범위     | 설명                                              |
|----------|------|----------|--------------------------------------------------|
| xTagged  | int  | [0,2]    | X正방향마크상태：0의미未캘리브레이션，1의미완료캘리브레이션，2의미통신실패 |
| yTagged  | int  | [0,2]    | Y正방향마크상태：0의미未캘리브레이션，1의미완료캘리브레이션，2의미통신실패 |
| zTagged  | int  | [0,2]    | Z正방향마크상태：0의미未캘리브레이션，1의미완료캘리브레이션，2의미통신실패 |
...
사용6차원힘 센서가져오기줄토크드래그，에서각축토크변환데이터超출력관절摩擦力补偿阈값을일 때가져오기줄摩擦力补偿。

...
| arcon_current | double | 起弧전류 | [0,1000]A |
...
| 매개변수名 | 유형 | 설명 |
|--------|------|------|
| arcon_current | double | 起弧전류 |
| arcon_voltage | double | 起弧电압력 |
| arcon_time | double | 起弧일 때사이 |
| arcon_ramp_time | double | 渐변경일 때사이 |
| arcon_ramp_distance | double | 渐변경거리 |
| arcon_ramp_enable | bool | 起弧渐변경활성화 |
| arcon_ramp_mode | int | 起弧渐변경방식（0：일 때사이渐변경，1：거리渐변경） |
...
설명：사용자명령어로이명령手이동설정点焊매개변수，포함：电焊전류、点焊电압력、点焊최대일 때사이。

| 매개변수名 | 유형 | 설명 |
|--------|------|------|
| spotWeldCurrent | double | 点焊전류 |

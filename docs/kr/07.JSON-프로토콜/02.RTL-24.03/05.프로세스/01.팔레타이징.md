...
### 7.10 平面모드사용자 정의모드预览（不저장매개변수와/과결과）
...
| robot | int | 현재로봇 |
| craftID | int | 프로세스번호 |
| O | array | 공작물起시작点，직교좌표계末端비트姿 |
| X | array | 열末端，직교좌표계末端비트姿 |
| Y | array | 줄末端，직교좌표계末端비트姿 |
| shift | array | 辅助点，직교좌표계末端비트姿 |
| enter | array | 입력口点，직교좌표계末端비트姿 |
| numX | int | 줄数 |
| numY | int | 열数 |
| numZ | int | 레이어 수 |

...
| swing_weld_frequency | int | 摆焊 주파수 1회 조정량 |
| swing_weld_range | double | 摆焊 진폭 1회 조정량 |
...
| weavParameterNotes | array | 摆焊 매개변수 주석 |
...
| weav.swing_amplitude | array | 摆焊 진폭: [최솟값, 최댓값] |
| weav.swing_frequency | array | 摆焊 주파수: [최솟값, 최댓값] |

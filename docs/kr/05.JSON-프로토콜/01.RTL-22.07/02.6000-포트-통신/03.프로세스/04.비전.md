...
| position | cameraPoint | array | 제1비트X값을，제二비트Y값을，제三비트高도，제四비트角도。<br/>若매개변수유형예2D와/과2D+H，则저장4元배열[x,y,H,angle]。<br/>若이(가)3D，则저장6元배열[x,y,z,a,b,c]。 |
...
| - | calculation_type | int | 0: 眼에서手아님변경자세手眼캘리브레이션<br/>1: 眼에서手변경자세手眼캘리브레이션<br/>2: 眼에서手이외手眼캘리브레이션 |

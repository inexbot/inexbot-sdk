...
![Teach pendant Tool Calibration interface used to set tool calibration points](assets/json-01.png)
...
![Teach pendant displaying the tool calibration calculation result after the 6-point or 7-point calibration completes](assets/json-02.png)
...
![Teach pendant dialog confirming clearing of an existing tool calibration record by point and tool number](assets/json-03.png)
...
![Teach pendant Tool Calibration interface showing stored calibration point positions [x,y,z,rx,ry,rz] for each point](assets/json-04.png)
...
![Teach pendant User Coordinate Calibration interface for marking the origin O and X/Y axis points](assets/json-05.png)
...
![Teach pendant User Coordinate annotation input dialog for entering the user coordinate note text](assets/json-06.png)
...
![Teach pendant 20-Point Calibration interface showing the calculated calibration result with distance value](assets/json-07.png)
...
![Teach pendant 20-Point Calibration interface prompting whether calibration can be started or has been completed](assets/json-08.png)

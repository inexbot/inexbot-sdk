...
![Terminal showing the catkin_init_workspace permission denied error](assets/ros-51.png)
...
![MoveIt Setup Assistant start screen with Create New MoveIt Configuration Package highlighted](assets/Y2PpHNn7_55a7b0d40ba6.png)

![MoveIt Setup Assistant dialog prompting to select a URDF file to load](assets/ros-52.png)

![Loaded URDF robot model with self-collisions panel in MoveIt Setup Assistant](assets/ros-53.png)

![MoveIt Setup Assistant virtual joints configuration panel](assets/ros-54.png)

![MoveIt Setup Assistant planning groups configuration panel with manipulator group defined](assets/ros-55.png)

![MoveIt Setup Assistant robot poses configuration panel with home pose defined](assets/ros-56.png)

![MoveIt Setup Assistant configuration files screen showing ROS controllers option](assets/ros-57.png)

![MoveIt Setup Assistant simulated controllers configuration screen](assets/ros-58.png)

![MoveIt Setup Assistant 3D perception configuration panel](assets/ros-59.png)

![MoveIt Setup Assistant simulation and kinematics configuration panels](assets/ros-60.png)

![MoveIt Setup Assistant final configuration package generation screen with Browse button](assets/ros-61.png)

![MoveIt Setup Assistant configuration package successfully generated dialog](assets/ros-62.png)

![RViz MotionPlanning plugin showing the loaded robot model with the Planning tab active](assets/Y2PpHNn7_e50cbca10734.png)

Copy the two folders from the inexbot_driver file and the generated moveit file:

![File manager showing the generated moveit folder and the inexbot_driver folders to copy](assets/Y2PpHNn7_3e9a2620ce20.png)
...
![moveit_planning_execution.launch file open in editor showing the default moveit folder names to replace](assets/Y2PpHNn7_c0b8527435a8.png)

![Terminal output showing the robot launching successfully with the moveit_planning_execution command](assets/Y2PpHNn7_22dbfc2bf7e4.png)

In `inexbot_support/config`, change the joint names in the two `.yaml` files to match the joint names in the URDF:

![YAML config file open in editor showing joint names to be updated to match the URDF](assets/Y2PpHNn7_c7ca93070868.png)
...
![qj_moveit_controller_manager.launch.xml file showing the highlighted controller path that needs editing](assets/Y2PpHNn7_67e085289ff0.png)
...
![RViz MotionPlanning plugin showing a planned trajectory after clicking Plan](assets/ros-63.png)

Click **Execute** to run the motion, or click **Plan & Execute** to plan and execute immediately.

![RViz MotionPlanning plugin with the robot executing the planned trajectory after clicking Execute](assets/ros-64.png)
...
![RViz MotionPlanning plugin with the interactive marker and 3D coordinate gizmo for drag planning](assets/ros-65.png)

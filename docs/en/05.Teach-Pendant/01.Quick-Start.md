...
![Qt 5.9.0 installer component selection screen showing the required checkboxes to enable for the teach pendant secondary development environment](assets/ks-01.png)
...
![Qt Creator Kits configuration page showing the LYX cross-compilation kit added for building teach pendant embedded applications](assets/ks-02.png)

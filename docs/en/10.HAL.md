...
![hal_sdk overall usage flowchart showing the relationship between DeviceManager and device classes](assets/hal-12.png)
...
![AnalogIO class usage flowchart showing get/set operations on analog channels](assets/hal-13.png)
...
![CANDevice class usage flowchart showing the open, set parameters, send, and receive workflow](assets/hal-14.png)
...
![DigitalIO class usage flowchart showing batch and single channel read/write operations](assets/hal-15.png)
...
![EncoderDevice class usage flowchart showing value, range, and direction queries](assets/hal-16.png)
...
![PwmDevice class usage flowchart showing start, stop, frequency, and duty cycle operations](assets/hal-17.png)
...
![SerialDevice class usage flowchart showing open, configure, send, and receive operations](assets/hal-18.png)
...
![UpsDevice class usage flowchart showing the status query path](assets/hal-19.png)

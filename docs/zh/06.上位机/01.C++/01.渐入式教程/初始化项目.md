...
![在Qt Creator的新建项目向导中选择"Qt Widgets Application"模板](assets/cpp-01.png)
...
![在Qt Creator中点击运行按钮以Release配置编译运行qt_demo项目](assets/cpp-02.png)
...
![在Visual Studio的创建新项目向导中选择C++"控制台应用"模板](assets/cpp-03.png)
...
![在Visual Studio工具栏中将解决方案配置切换为Release并启动本地Windows调试器](assets/cpp-04.png)
...
![Linux下C++项目的目录结构，包含include、lib、src文件夹和Makefile构建文件](assets/cpp-05.png)

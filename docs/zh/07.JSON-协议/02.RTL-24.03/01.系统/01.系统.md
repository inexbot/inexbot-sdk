...
| controllerFunction | string | 控制器功能版本，默认 "BASE" |
| controllerProject | string | 项目版本号，默认 "1.0.0" |
| controllerModel | string | 控制器型号，默认 "C1102" |
| controllerMaster | string | 主站类型，默认 "EtherCAT" |
| controllerFactory | string | 厂家，默认 "INEXBOT" |
...
```json
{
  ...
  "version": "v1.0-rc1-67-gf34dae7",
  "controllerFunction": "BASE",
  "controllerProject": "1.0.0",
  "controllerModel": "C1102",
  "controllerMaster": "EtherCAT",
  "controllerFactory": "INEXBOT"
}
```

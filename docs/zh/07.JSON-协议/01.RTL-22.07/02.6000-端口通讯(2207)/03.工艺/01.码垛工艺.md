...
![设置抓手参数0x4201 PAL_GRIPPER_PARM_SET的JSON数据格式](assets/json-23.png)
...
![设置托盘参数0x4204 PAL_PALLET_PARM_SET的JSON数据格式](assets/json-24.png)
...
![设置位置参数0x4207 PAL_POS_PARM_SET的JSON数据格式](assets/json-25.png)
...
![设置工件参数0x420A PAL_WORKPIECE_PARM_SET的JSON数据格式](assets/json-26.png)
...
![设置重叠模式参数0x4210 PAL_OVERLAP_PARM_SET的JSON数据格式](assets/json-27.png)
...
![设置平面模式参数0x4213 PAL_PLANE_PARM_SET的JSON数据格式](assets/json-28.png)
...
![设置码垛状态0x421A PAL_STATE_SET的JSON数据格式](assets/json-29.png)
...
![复制码垛参数0x421D PAL_PARM_COPY的JSON数据格式](assets/json-30.png)
...
![复制层图形参数0x421F PAL_GRAPHIC_COPY的JSON数据格式](assets/json-31.png)
...
![切换使用码垛类型0x4221 PAL_SIMPLE_SWTICH的JSON数据格式](assets/json-32.png)
...
![简易码垛0x4224 PAL_SIMPLE_POS_SET的JSON数据格式](assets/json-33.png)
...
![码垛复位0x422C PAR_PARM_RESET的JSON数据格式](assets/json-34.png)
...
![点位调试界面返回全部工件数据0x4243 PAL_POINTDEBUG_FLOORDATA_RESPOND的JSON数据格式](assets/json-35.png)

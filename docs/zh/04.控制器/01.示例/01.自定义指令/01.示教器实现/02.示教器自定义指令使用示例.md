...
![示教器二次开发demo中设计好的自定义指令界面示例](assets/sj-demo-01.png)
...
```
![调用userdefined_cmd_name_change接口后指令插入界面中显示"换枪动作"和"移动到换枪位置"的名称效果](assets/sj-demo-02.png)
...
![自定义指令参数封装并通过userdefine_cmd_insert接口插入到作业文件的效果示例](assets/sj-demo-03.png)

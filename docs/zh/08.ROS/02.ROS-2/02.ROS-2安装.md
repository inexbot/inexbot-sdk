...
![lsb_release 命令显示 Ubuntu 22.04 版本信息](assets/ros2-14.png)
...
![ROS 2 talker 发布者终端显示 Hello World](assets/ros2-15.png)
...
![ROS 2 listener 订阅者终端收到 Hello World](assets/ros2-16.png)
...
![小海龟仿真器与键盘控制运行效果](assets/ros2-17.png)
...
![小鱼的一键安装脚本选项界面](assets/ros2-18.png)

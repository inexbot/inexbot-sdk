...
![rosdep init 成功输出提示写入 20-default.list 并建议执行 rosdep update](assets/ros-20.png)

![rosdep update 成功输出显示读取源列表、下载 yaml、添加发行的 ROS 发行版](assets/ros-21.png)
...
![TurtleSim 仿真器窗口中显示一只棕色小海龟以及它走过的白色轨迹线](assets/ros-22.png)

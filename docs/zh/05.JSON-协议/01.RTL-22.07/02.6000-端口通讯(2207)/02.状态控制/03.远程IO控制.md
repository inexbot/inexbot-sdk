...
| value2 | int | IO 电平参数：0-低电平，1-高电平 |
...
|--------|------|------|
| enable | bool | 使能 |
| port1 | int | 紧急停止1 DIN 序号（1~16） |
| value1 | int | IO 电平参数：0-低电平，1-高电平 |
| port2 | int | 紧急停止2 DIN 序号（1~16） |
| value2 | int | IO 电平参数：0-低电平，1-高电平 |
...
| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| enable | array | 是 | 每有一块 IO 板增加16个数据：1-使能端口报警，2-不使能 |
| value | array | 是 | 每有一块 IO 板增加16个数据：端口电平状态，1-高电平，0-低电平 |
| msg | array | 是 | 每有一块 IO 板增加16个数据：消息内容 |

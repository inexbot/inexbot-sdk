...
|--------|------|------|------|
| robot | int | 是 | 机器人编号 |
| direction | int | 是 | 方向：0-下降 1-上升 (100ms 内发送) |
...
![调高器点动0x91A4点动控制的 JSON 数据格式](assets/json-36.png)
...
| rAngleTrackLevel | int | 否 | R 角跟随等级 |
...
![电容标定0x91AA 电容标定的 JSON 数据格式](assets/json-37.png)

---

## 0x91B0 CNC 发送实时 Z 轴速度

**请求参数**

| 参数名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| cncSpeed | int | 否 | Z 轴速度，单位：μm/ms |

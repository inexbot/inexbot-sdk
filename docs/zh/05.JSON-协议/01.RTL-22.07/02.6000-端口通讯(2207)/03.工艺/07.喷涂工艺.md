...
**消息 ID**: 0x4701 `SPRAY_ANALOGGROUP_SET`
...
**消息 ID**: 0x4702 `SPRAY_ANALOGROUP_INQUIRE`
...
**消息 ID**: 0x4703 `SPRAY_ANALOGROUP_RESPOND`
...
**消息 ID**: 0x4704 `SPRAY_DIGIT_PARM_SET`
...
**消息 ID**: 0x4705 `SPRAY_DIGIT_PARM_INQUIRE`
...
**消息 ID**: 0x4706 `SPRAY_DIGIT_PARM_RESPOND`

**返回参数**: 同设置 (0x4704)

### 2.4 时序设置

**消息 ID**: 0x4707 `SPRAY_SEQUENTIAL_SET`
...
**消息 ID**: 0x4708 `SPRAY_SEQUENTIAL_INQUIRE`
...
**消息 ID**: 0x4709 `SPRAY_SEQUENTIAL_RESPOND`
...
**消息 ID**: 0x470A `SPRAY_TRAJECTORY_SET`
...
**消息 ID**: 0x470B `SPRAY_TRAJECTORY_INQUIRE`
...
**消息 ID**: 0x470C `SPRAY_TRAJECTORY_RESPOND`
...
**消息 ID**: 0x4711 `SPRAY_HAND_OPERATION_SET`
...
**消息 ID**: 0x4712 `SPRAY_HAND_OPERATION_INQUIRE`
...
**消息 ID**: 0x4713 `SPRAY_HAND_OPERATION_RESPOND`
...
**消息 ID**: 0x4714 `SPRAY_CUR_ANALOG_SET`
...
**消息 ID**: 0x4715 `SPRAY_CUR_ANALOG_INQUIRE`
...
**消息 ID**: 0x4716 `SPRAY_CUR_ANALOG_RESPOND`
...
**消息 ID**: 0x4717 `SPRAY_CUR_OILTIME_SET`
...
**消息 ID**: 0x4718 `SPRAY_CUR_OILTIME_INQUIRE`
...
**消息 ID**: 0x4719 `SPRAY_CUR_OILTIME_RESPOND`

...
| weaving_type | int | 摆动类型：0-正弦，1-Z 字形，2-圆形摆，3-外部轴定点摆 |
...
开始进行模拟量匹配：建立电流电压匹配界面会发送 true，离开 false
...
| result | bool | 标定结果 |
| workPieceNum | int | 工件号 |
| cylinderIntersectLineParam.R | double | 相贯线参数 R |
| cylinderIntersectLineParam.alpha | double | 相贯线参数 alpha |
| cylinderIntersectLineParam.e | double | 相贯线参数 e |
| cylinderIntersectLineParam.r | double | 相贯线参数 r |
...
| 参数名 | 类型 | 说明 |
|--------|------|------|
| WeldingGunParam.alpha | double | 焊枪角度 alpha |
| WeldingGunParam.beta | double | 焊枪角度 beta |
| WeldingGunParam.gama | double | 焊枪角度 gama |
